...
extern "C" {
	...
	extern int ws_get_ch1_range(ws_cli_conn_t *cli);
	extern int ws_get_ch2_range(ws_cli_conn_t *cli);
	extern void ws_set_ch1_range(ws_cli_conn_t *client, int range);
	extern void ws_set_ch2_range(ws_cli_conn_t *client, int range);
